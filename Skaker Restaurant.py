...
# Placing icons in the background
    ...
    cup_image = background.resize((75, 75), Image.Resampling.LANCZOS)  # Use LANCZOS instead of ANTIALIAS
    ...
    def calculate_bill(order):
        ...
        for dish_name, quantity, price in order:
            line_total = price
            bill_details.append(f"{dish_name:<20}{quantity:<10}${line_total:<10}")
